...
router.get(
  '/productos/externo/:codigo',
  autenticar,
  soloAdmin,
  productosController.consultarExterno.bind(productosController),
);
...
router.post(
  ...
  autenticar,
  soloAdmin,
  validarBody(crearProductoSchema),
  productosController.crear.bind(productosController),
);
router.post(
  '/productos/:id/imagen',
  autenticar,
  ...
  productosController.subirImagenLocal.bind(productosController),
);
router.post(
  '/productos/:id/presign-imagen',
  autenticar,
  soloAdmin,
  productosController.presignImagen.bind(productosController),
);
router.post(
  '/productos/:id/confirmar-imagen',
  autenticar,
  soloAdmin,
  productosController.confirmarImagen.bind(productosController),
);
...
router.put(
  ...
  autenticar,
  soloAdmin,
  validarBody(actualizarProductoSchema),
  productosController.actualizar.bind(productosController),
);
