...
clienteRouter.post(
  ...
  pedidosController.subirComprobanteLocal.bind(pedidosController),
);
clienteRouter.post(
  '/:id/presign-comprobante',
  autenticarCliente,
  pedidosController.presignComprobante.bind(pedidosController),
);
clienteRouter.post(
  '/:id/confirmar-comprobante',
  autenticarCliente,
  pedidosController.confirmarComprobante.bind(pedidosController),
);
clienteRouter.get(
  '/:id/comprobante',
  autenticarCliente,
  pedidosController.verComprobanteCliente.bind(pedidosController),
);
...
adminRouter.get(
  ...
  autenticar,
  soloAdministrador,
  pedidosController.verComprobanteAdmin.bind(pedidosController),
);
adminRouter.post(
  '/:id/rechazar',
  autenticar,
  soloAdministrador,
  validarBody(rechazarPedidoSchema),
  pedidosController.rechazarPedidoAdmin.bind(pedidosController),
);
adminRouter.post(
  '/:id/aprobar',
  autenticar,
  soloAdministrador,
  pedidosController.aprobarPedidoAdmin.bind(pedidosController),
);
adminRouter.post(
  '/:id/listo',
  autenticar,
  soloAdministrador,
  pedidosController.cambiarEstadoListo.bind(pedidosController),
);
adminRouter.post(
  '/:id/entregar',
  autenticar,
  soloAdministrador,
  pedidosController.cambiarEstadoEntregar.bind(pedidosController),
);
