...
export const toProductoDto = (producto: any) => {
  ...
  return {
    ...
    stockMinimo:
      producto.stockMinimoPro !== null && producto.stockMinimoPro !== undefined
        ? Number(producto.stockMinimoPro)
        : null,
    ...
    marca:
      producto.idMarca || producto.marca || producto.nombreMarca || producto.marcaNombre
        ? {
        ...
        : null,
    categoria:
      producto.idCat || producto.categoria || producto.nombreCat || producto.categoriaNombre
        ? {
